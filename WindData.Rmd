...
journal_upset_df <- journal_wind_df %>%
  mutate(
    # Sets for UpSet intersections
    WindMentioned = wind_mentioned == "Yes",
    HasDirection  = !is.na(wind_dir_math_real),
    StrongWind    = !is.na(beaufort) & beaufort >= 3, # moderate+ winds
    Winter        = month_numeric %in% c(12, 1, 2),
    
    # Ensure numeric columns are numeric
    wind_dir_math_real = as.numeric(wind_dir_math_real),
    month_numeric = as.numeric(month_numeric),
    year = as.numeric(format(date_mdy, "%Y"))
  )
