...
```{r}
top_from <- dplyr::filter(from_count, grepl('C. C. Burill|C.C. Burrill|C.c. Burrill|CC Burrill|Charles C. Burrill|Charles C Burill|Benjamin Kittridge|Thomas Bunker|Capt. Thomas Bunker|J.F. Kingsley|J.F.K|JFK|Jfk|J F Kingsley| J. F. Kingsley', from))
```
...
```
```{r}
mapping <- c("C. C. Burrill" = 44.5434, "C.C. Burrill" = 44.5434, "C.c. Burrill" = 44.5434,"CC Burrill" = 44.5434,"Charles C. Burrill" = 44.5434,"Charles C Burill" = 44.5434, "Benjamin Kittridge" = 2, "Thomas Bunker" = 3, "Capt. Thomas Bunker" = 3)
