...
```{r}
Top_2 <-   
  dplyr::filter(write_letters, grepl('C. C. Burrill|C.C. Burrill|C.c. Burrill|CC Burrill|Charles C. Burrill|Charles C Burrill|Benjamin Kittridge|Thomas Bunker|Capt. Thomas Bunker', to))%>%
  rename(person = to)
Top_f <-
  dplyr::filter(read_letters, grepl('C. C. Burill|C.C. Burrill|C.c. Burrill|CC Burrill|Charles C. Burrill|Charles C Burill|Benjamin Kittridge|Thomas Bunker|Capt. Thomas Bunker', from))%>%
  rename(person = from)

top <- dplyr::bind_rows(Top_2, Top_f)
```
```{r}
mapping <- c("C. C. Burrill" = 1, "C.C. Burrill" = 1, "C.c. Burrill" = 1,"CC Burrill" = 1,"Charles C. Burrill" = 1,"Charles C Burill" = 1, "Benjamin Kittridge" = 2, "Thomas Bunker" = 3, "Capt. Thomas Bunker" = 3)
